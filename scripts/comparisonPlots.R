...
smBoxData <- data.frame("method" = character(7000),
                        "estD" = numeric(7000))
...
smBoxData$estD[5001:6000] <- Plotresults4m$dhat_singleObs
smBoxData$estD[6001:7000] <- Plotresults4m$dhat_doubleObs
...
par(mar=c(4,5,2,2))
boxplot(smBoxData$estD~smBoxData$method, xlab = "", ylab = expression(italic(hat(D))), mgp = c(3, 2, 0), xaxt = "n", xpd = TRUE)
...
mtext(expression(1~m^2), side = 1, line = 2.2, at = 4) 
mtext("single obs", side = 1, line = 1, at = 5)
mtext(expression(1~m^2), side = 1, line = 2.2, at = 5)
mtext("double obs", side = 1, line = 1, at = 6)
mtext(expression(4~m^2), side = 1, line = 2.2, at = 6)
mtext("single obs", side = 1, line = 1, at = 7)
mtext(expression(4~m^2), side = 1, line = 2.2, at = 7)
...
par(mar = c(4,5,2,2))
boxplot(sqBoxData2$estD~sqBoxData2$method, xlab = "", ylab = expression(italic(hat(D))), ylim = c(0, 0.42), xaxt = "n", xpd = TRUE, mgp = c(3, 2, 0))
...
par(mar = c(4,6,2,2))
boxplot(SmUnbandedBox$estD~SmUnbandedBox$method , xlab = "", ylab = expression(italic(hat(D))), ylim = c(0, 9), xaxt = "n", xpd = TRUE, mgp = c(3, 2, 0))
